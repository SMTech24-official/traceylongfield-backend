...
router.patch("/update-profile", (0, auth_1.default)(constant_1.USER_ROLE.admin, constant_1.USER_ROLE.author), fileUpload_1.fileUploader.uploadSingle, user_controller_1.userController.updateUserProfile);
// get all user 
router.get("/get-all-users", (0, auth_1.default)(constant_1.USER_ROLE.admin, constant_1.USER_ROLE.superAdmin), user_controller_1.userController.getAllUsers);
